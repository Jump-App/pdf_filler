...
```sh
curl -L -o pdf_filler \
  https://github.com/<owner>/<repo>/releases/download/v0.1.2/pdf_filler-x86_64-unknown-linux-gnu
chmod +x pdf_filler
```
...
```sh
curl -L -O https://github.com/<owner>/<repo>/releases/download/v0.1.2/checksums.txt
